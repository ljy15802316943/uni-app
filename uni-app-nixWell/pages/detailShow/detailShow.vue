<template>
	<view class="detail-show">
		<scroll-view :scroll-x="true" style="margin-bottom: 5rem;">	
			...
			<view class="Buy-type" @touchstart="handleBuyType">
				<view class="font-size">
					<text style="color: #606266;">购买类型</text>
				</view>
				<view class="font-size" style="margin: 0 1rem;">
			...
			<view class="coupons">
				...
				<text class="font-size" style="width: 5rem; color: #fa436a;">领取优惠卷</text>
