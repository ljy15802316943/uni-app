<template>
	<view class="buy-type">
		<view :class="{'mengcheng': buyTypeState}" @touchstart="handleHiddenBuyType"></view>
		<view class="popup-window" :class="{'popup-show': buyTypeState}">
			...
			<view class="size">
				...
				<view class="size-box">
					<view class="size-list" :class="{'size-index': sizeIndex == index}" v-for="(item, index) in sizeList" :key="index" @touchstart="handleSizeClick(index, item.content)">
			...
			<view class="color">
				...
				<view class="color-box">
					<view class="color-list" :class="{'color-index': colorIndex == index}" v-for="(item, index) in sizeColorList" :key="index" @touchstart="handleSizeColorClick(index, item.content)">
						<text>{{item.content}}</text>
					</view>
				</view>
			</view>
			<view class="complete" @touchstart="handleHiddenBuyType">
				<text>完成</text>
			</view>
		</view>
	</view>
